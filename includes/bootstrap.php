...
/**
 * CmsForNerd - Centralized Bootstrap (Laboratory Engine)
...
// This handles PSR-4 loading for the CmsForNerd namespace.
require_once __DIR__ . '/../vendor/autoload.php';

// 2. [LAB] Load Function Declarations
// PSR-1 compliance: These files ONLY contain functions, no "side effects".
require_once __DIR__ . '/global-control.inc.php';
require_once __DIR__ . '/common.inc.php';

/**
 * 3. [LAB] Initialization Phase
 * We execute the functions from the CmsForNerd namespace.
 */
